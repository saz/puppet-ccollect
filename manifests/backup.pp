define ccollect::backup($ensure = present, $ssh_user = 'root', $source = '/', $destination = "${fqdn}", $exclude = undef, $rsync_options = '', $delete_incomplete = 'y', $pre_exec = undef, $post_exec = undef) {
